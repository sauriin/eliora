...
export default function ElioraRegistration() {
    ...
    // 🧹 Removed registration deadline code
    ...
    const validateForm = () => {
        ...
        if (!formData.emergencyContact.trim())
            ...
            newErrors.emergencyContact = "Emergency contact cannot be same as WhatsApp number";
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            if (file.size > 2 * 1024 * 1024) {
                setErrors((prev) => ({ ...prev, paymentProof: "File must be under 2MB." }));
                return;
            }
        ...
        <div className="min-h-screen bg-white font-poppins">
            ...
            <div className="container max-w-3xl mx-auto px-4 py-8">
                <div className="space-y-8">
                    <div>
                        ...
                        <div className="text-gray-600 mt-2 text-base leading-relaxed space-y-2">
                            ...
                            <div className="space-y-1">
                                ...
                                <p><strong>Registration Fee:</strong> ₹1000/- (Includes food & accommodation)</p>
                            </div>
                        </div>
                        <div className="mt-4 text-gray-600">
                            <p>For any concern please reach out:</p>
                            <ul className="mt-2 space-y-1">
                                <li>Honey Chavda: +91 63520 55646</li>
                                <li>Francis Tellis: +91 99980 71630</li>
                                <li>Sejal Macwan: +91 93134 33681</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    {/* REGISTRATION FORM ALWAYS ACTIVE */}
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {paymentMethod === "online" && (
                            <div className="space-y-4 border-l-4 border-blue-500 pl-4 py-2">
                                <p className="text-sm font-medium text-gray-900 mb-2">
                                    Please scan the QR to pay ₹1000/-.
                                </p>
                                <img
                                    src={paymentQR.src}
                                    alt="UPI QR"
                        ...
                        <div className="flex justify-end pt-6">
                            <button
                                ...
                                className={`inline-flex items-center justify-center h-12 px-8 rounded-full text-base font-medium text-white ${registering
